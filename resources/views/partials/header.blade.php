<header class="fixed z-20 top-0 w-full">
    <nav-menu :alt="true" :top="50">
        ...
        <ul class="relative z-10 flex flex-col lg:flex-row lg:flex-wrap justify-center lg:justify-end items-center lg:items-end text-lg lg:text-lg leading-tight">
            ...
            <li class="mx-3 w-full lg:w-auto lg:text-center relative"><a class="menu-link inline-block py-2 px-4 button ml-4 lg:ml-0" href="https://jaliscoatualcance.visitjalisco.com.mx/"><span class="inline-block lg:block uppercase text-sm font-bold">@lang('menu.offers')</span></a></li>
