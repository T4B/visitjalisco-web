...
<section class="coming-soon multiply bg-cover bg-no-repeat bg-center" style="background-image:url({{ asset('images/back_proximamente.jpg') }})">
    <div class="container hero-content flex w-full items-center">
        <div class="flex-1 font-secondary text-center">
            ...
            <a class="button text-xl lg:text-2xl font-bold mx-auto  px-8 py-2 shadow-md" href="{{ route('home') }}"> @lang('general.go-back') </a>
        </div>
    </div>
</section>
